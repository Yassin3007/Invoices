...
@section('title','لوحة التحكم _ برنامج الفواتير')
@section('css')
    <!--  Owl-carousel css-->
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7"> from {{\App\Models\Invoice::count()}} Invoices</p>
                            </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">from {{\App\Models\Invoice::where('Value_Status',2)->count()}} Invoices</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">from {{\App\Models\Invoice::where('Value_Status',1)->count()}} Invoices</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">from {{\App\Models\Invoice::where('Value_Status',3)->count()}} Invoices</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
